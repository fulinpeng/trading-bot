...
const config = {
    'eth': {
        ...
        multiplier: 30,                      // SuperTrend ATR 乘数
        ...
        enableReversalEntry: false,          // 启用反转入场
        ...
        // profitR 分阶段阈值（profitR = 盈亏R倍数，且使用“初始止损”计算）
        moveStopProfitRTier1: 2,             // <Tier1：停留在初始止损
        moveStopProfitRTier2: 4,             // <Tier2：移动到 entry（保本）
        moveStopProfitRTier3: 9,             // <Tier3：使用 ATR*Tier3

        // 对应阶段的 ATR 倍数（移动止损的 atr 挡位）
        moveStopAtrMultiplierTier3: 7,       // Tier2~Tier3：close +/- ATR*Tier3
        ...
        enableIndicatorStopLoss: false,        // 启用 高风险检测 15：24359 156单 （收益曲线非常乱，不好） | 30：30350 135单
        ...
        enableAtrZCompressedJudge: false,    // 启用ATR Z-Score判断压缩行情 39316 71单 2次平0.5：33210 

        // 冷却时，仓位减半
        enableCoolingMechanism: false,        // 启用冷却机制，默认关闭(仅在亏损时冷却，冷却时仓位减半) 效果不理想
        ...
        tpCountForStopLoss: 2,                 // 指标止盈计数关键字，用于判断是否达到开启保本止损条件
