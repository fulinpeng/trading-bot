...
let isFirstGetProfit = false; // 开单就是 true 有了盈利就为 false
...
const judgeAndTrading = async () => {
    ...
    isFirstGetProfit = false; // 开单成功就设置为false>>>>>>>
...
function calculateTradingSignal() {
    ...
    if (false && kLine3.close > kLine3.open && kLine3.low <= sma && sma < kLine3.close) {
    ...
    if (false && kLine3.close < kLine3.open && kLine3.high >= sma && sma > kLine3.close) {
