...
const calculateTradingSignal=(kLines) => {
	...
	if (readyTradingDirection==="up"&&close>Math.max(demaShort, demaLong)) { // &&signalUpTerm1
	...
	if (readyTradingDirection==="down"&&close<Math.min(demaShort, demaLong)) { // &&signalDownTerm1
